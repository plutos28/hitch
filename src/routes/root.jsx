        ...
        <div className="col-span-4 flex justify-between">
            ...
            <NavLink
              ...
              {({ isActive, isPending }) => (
                <>
                  <svg
                    className={`${isActive ? 'fill-blue-500' : 'fill-hitchUnselectedTab'} ${isPending ? '' : ''}`}
                  ...
                  <p
                    className={`text-[12px] ${isActive ? 'text-hitchBlue' : 'fill-hitchUnselectedTab'} ${isPending ? '' : ''}`}
                  >
                    Home
                  </p>
                </>
            ...
            <NavLink
              ...
              {({ isActive, isPending }) => (
                <>
                  <svg className="{`${isActive ? 'fill-blue-500' : 'fill-hitchUnselectedTab'} ${isPending ? '' : ''}`}" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#000000" viewBox="0 0 256 256"><path d="M208,32H184V24a8,8,0,0,0-16,0v8H88V24a8,8,0,0,0-16,0v8H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32ZM84,184a12,12,0,1,1,12-12A12,12,0,0,1,84,184Zm44,0a12,12,0,1,1,12-12A12,12,0,0,1,128,184Zm0-40a12,12,0,1,1,12-12A12,12,0,0,1,128,144Zm44,40a12,12,0,1,1,12-12A12,12,0,0,1,172,184Zm0-40a12,12,0,1,1,12-12A12,12,0,0,1,172,144Zm36-64H48V48H72v8a8,8,0,0,0,16,0V48h80v8a8,8,0,0,0,16,0V48h24Z"></path></svg>
                  <p
                    className={`text-[12px] ${isActive ? 'text-hitchBlue' : 'fill-hitchUnselectedTab'} ${isPending ? '' : ''}`}
                  >
                    History
            ...
            <NavLink
              ...
              {({ isActive, isPending }) => (
                <>
                  <svg className={`${isActive ? 'fill-blue-500' : 'fill-hitchUnselectedTab'} ${isPending ? '' : ''}`} xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#000000" viewBox="0 0 256 256"><path d="M216,130.16q.06-2.16,0-4.32l14.92-18.64a8,8,0,0,0,1.48-7.06,107.6,107.6,0,0,0-10.88-26.25,8,8,0,0,0-6-3.93l-23.72-2.64q-1.48-1.56-3-3L186,40.54a8,8,0,0,0-3.94-6,107.29,107.29,0,0,0-26.25-10.86,8,8,0,0,0-7.06,1.48L130.16,40Q128,40,125.84,40L107.2,25.11a8,8,0,0,0-7.06-1.48A107.6,107.6,0,0,0,73.89,34.51a8,8,0,0,0-3.93,6L67.32,64.27q-1.56,1.49-3,3L40.54,70a8,8,0,0,0-6,3.94,107.71,107.71,0,0,0-10.87,26.25,8,8,0,0,0,1.49,7.06L40,125.84Q40,128,40,130.16L25.11,148.8a8,8,0,0,0-1.48,7.06,107.6,107.6,0,0,0,10.88,26.25,8,8,0,0,0,6,3.93l23.72,2.64q1.49,1.56,3,3L70,215.46a8,8,0,0,0,3.94,6,107.71,107.71,0,0,0,26.25,10.87,8,8,0,0,0,7.06-1.49L125.84,216q2.16.06,4.32,0l18.64,14.92a8,8,0,0,0,7.06,1.48,107.21,107.21,0,0,0,26.25-10.88,8,8,0,0,0,3.93-6l2.64-23.72q1.56-1.48,3-3L215.46,186a8,8,0,0,0,6-3.94,107.71,107.71,0,0,0,10.87-26.25,8,8,0,0,0-1.49-7.06ZM128,168a40,40,0,1,1,40-40A40,40,0,0,1,128,168Z"></path></svg>
                  <p
                    className={`text-[12px] ${isActive ? 'text-hitchBlue' : 'fill-hitchUnselectedTab'} ${isPending ? '' : ''}`}
                  >
                    Settings
